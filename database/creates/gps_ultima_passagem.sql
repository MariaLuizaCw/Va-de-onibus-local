...
CREATE INDEX IF NOT EXISTS idx_gps_ultima_passagem_linha 
ON gps_ultima_passagem(linha);

-- Índice para consultas por datahora_atualizacao (útil para cleanup e validade)
CREATE INDEX IF NOT EXISTS idx_gps_ultima_passagem_datahora 
ON gps_ultima_passagem(datahora_atualizacao);
